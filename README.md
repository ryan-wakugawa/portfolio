...
<p align="center">
  <img src="./img/foto.jpg" width="200" alt="Foto de Ryan Seiji Wakugawa">
  </img>
</p>

Meu nome é Ryan Seiji Wakugawa e tenho 22 anos. Comecei meus estudos em 2018 com um curso técnico em Automação Industrial pela Etec Profª Ilza Nascimento Pintus. Tive a oportunidade de me aprofundar no mundo da programação em uma das aulas e decidi que esse seria o caminho que gostaria de seguir. Depois de me formar, comecei a cursar Análise e Desenvolvimento de Sistemas pela FATEC São José dos Campos - Prof. Jessen Vidal em 2023.

Atualmente estou atuando como estagiário na empresa [Processware](https://www.processwaregroup.com/). Também já realizei alguns serviços como suporte de TI durante meu serviço militar em 2022.
...
Me considero um desenvolvedor full stack, com mais familiaridade com o back-end. Dentre as tecnologias que aprendi, destacam-se:
...
- [Ryan Seiji Wakugawa](#ryan-seiji-wakugawa)
  - [Contatos](#contatos)
...
Durante o projeto, tive que exercer a soft skill de **solução de problemas** para resolver um erro com a geração de IDs no banco de dados. Como solução, criei uma função para adicionar um ID antes da criação da entidade.

Além disso, coloquei em prática a soft skill **trabalho em equipe** ao colaborar com membros do grupo na criação de novas telas de cadastro e exibição para a aplicação.
